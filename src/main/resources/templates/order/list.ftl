    ...
    <div id="page-content-wrapper">
            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/sell/seller/order/detail?orderId=${orderDTO.orderId}&page=${currentPage}&size=${size}">详情</a>
                        </td>
                        <td>
                            <#if orderDTO.getOrderStatusEnum().message == "新订单">
                                <a href="/sell/seller/order/cancel?orderId=${orderDTO.orderId}&page=${currentPage}&size=${size}">取消</a>
                            </#if>
                        </td>
                    </tr>
                    </#list>
        ...
        <#--分页-->
            <div class="col-md-12 column">
                ...
                <#else >
                        <li><a href="/sell/seller/order/list?page=${currentPage - 1}&size=${size}">上一页</a>
                        </li>
                </#if>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="location.reload()" type="button" class="btn btn-primary" >
                        <a href="/sell/seller/order/list?page=${orderDTOPage.getTotalPages()}&size=${size}" >查看新的订单</a>
                </button>
            </div>
        </div>
    </div>
